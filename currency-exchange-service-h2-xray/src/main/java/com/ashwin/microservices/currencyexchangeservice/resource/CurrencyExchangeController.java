package com.ashwin.microservices.currencyexchangeservice.resource;

import java.util.Map;

import com.ashwin.microservices.currencyexchangeservice.util.containerservice.ContainerMetaDataService;
